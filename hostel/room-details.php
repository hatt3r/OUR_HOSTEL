...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/programs php/hostel/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>
